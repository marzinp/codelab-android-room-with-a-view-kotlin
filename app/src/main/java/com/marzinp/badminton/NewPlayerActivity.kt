...
/**
 * Activity for entering a player.
 */
...
class NewPlayerActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val editPlayerView = findViewById<EditText>(R.id.edit_player)
    ...
    companion object {
        const val EXTRA_REPLY = "com.marzinp.badminton.playerlistsql.REPLY"
    }
}
